...
const G = {
  ...
  fixedAcc: 0, tick: 0,
  // Whether hosted rooms fill spare seats with bots. Off means PLAYERS ONLY —
  // no bots at all, and the room needs at least two real players to start.
  botsEnabled: true
};
...
function setBotsEnabled(enabled) {
  G.botsEnabled = !!enabled;
  return G.botsEnabled;
}
